...
mod copilot_tests {
    #[test]
    fn recognizes_platform_binary_names() {
        assert!(super::name_matches_known_binary("copilot"));
        assert!(super::name_matches_known_binary("copilot.exe"));
        assert!(!super::name_matches_known_binary("copilotx"));
    }
}
